[
    ...
    },
    {
      "type": "impl",
      "name": "OracleImpl",
      "interface_name": "ekubo::extensions::oracle::IOracle"
    },
    {
      "type": "enum",
    ...
    {
      "type": "interface",
      "name": "ekubo::extensions::oracle::IOracle",
      "items": [
        {
          "type": "function",
    ...
    {
      "type": "struct",
      "name": "ekubo::types::snapshot::Snapshot",
      "members": [
        {
    ...
    {
      "type": "event",
      "name": "ekubo::extensions::oracle::Oracle::SnapshotEvent",
      "kind": "struct",
      "members": [
        {
          "name": "token0",
        ...
        {
          "name": "snapshot",
          "type": "ekubo::types::snapshot::Snapshot",
          "kind": "data"
        }
      ]
    },
    {
      "type": "event",
      "name": "ekubo::extensions::oracle::Oracle::Event",
      "kind": "enum",
      "variants": [
        {
        ...
        {
          "name": "SnapshotEvent",
          "type": "ekubo::extensions::oracle::Oracle::SnapshotEvent",
          "kind": "nested"
        }
      ]
    }
