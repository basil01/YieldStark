[
    {
      ...
      "interface_name": "vesu::extension::default_extension_po::IDefaultExtension"
    },
    {
      "type": "enum",
    ...
    {
      "type": "interface",
      "name": "vesu::extension::default_extension_po::IDefaultExtension",
      "items": [
        {
          "type": "function",
          "name": "pool_name",
    ...
    {
      "type": "event",
      "name": "vesu::extension::default_extension_po::DefaultExtensionPO::SetAssetParameter",
      "kind": "struct",
      "members": [
        {
          "name": "pool_id",
    ...
    {
      "type": "event",
      "name": "vesu::extension::default_extension_po::DefaultExtensionPO::SetPoolOwner",
      "kind": "struct",
      "members": [
        {
          "name": "pool_id",
    ...
    {
      "type": "event",
      "name": "vesu::extension::default_extension_po::DefaultExtensionPO::Event",
      "kind": "enum",
      "variants": [
        {
        ...
        },
        {
          ...
          "type": "vesu::extension::default_extension_po::DefaultExtensionPO::SetAssetParameter",
          "kind": "nested"
        },
        {
          "name": "SetPoolOwner",
          "type": "vesu::extension::default_extension_po::DefaultExtensionPO::SetPoolOwner",
          "kind": "nested"
        }
      ]
    }
